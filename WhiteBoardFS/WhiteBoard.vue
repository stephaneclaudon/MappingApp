                    ...
                    <ul id="toolList" style="list-style: none;">
                        ...
                        <li style="display:none">
                            <div class="toolsButtons">
                                <button id="pencil" class="btn btn-default"><span class="glyphicon glyphicon-pencil"
...
#colorsSelector li.item,
#sizeSelector li.item {
    border-radius: 100%;
    height: 40px;
    width: 40px;
    margin: 5px auto;
...
#stickerAdded {
    opacity: 0;
    /* Initialiser l'opacité à 0 pour cacher l'image au départ */
    transition: opacity 1s ease-in-out;
    /* Ajouter une transition de l'opacité sur l'image */
}
